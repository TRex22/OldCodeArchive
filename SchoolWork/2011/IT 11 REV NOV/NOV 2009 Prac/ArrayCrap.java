...
public class ArrayCrap {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		//insert
		String ins = JOptionPane.showInputDialog("Enter the input to add to array");
		int inspos = Integer.parseInt(JOptionPane.showInputDialog("Enter ins pos"));
		for (int i=count;i>inspos-1;i--)
		{
			Title[i]=Title[i-1];
