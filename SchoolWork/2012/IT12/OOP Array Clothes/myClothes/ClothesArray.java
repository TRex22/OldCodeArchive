...
public class ClothesArray {
	...
	public String insertHotel (String garment, int position)
	{
		if (position>=0&&position<size)
		{
			...
			arr[position].setDesc(garment);
			size++;
			
			return "grament ws inserted";
		}
		else if (position == size) 
		{
			arr[size].setDesc(garment);
			size++;
			return "grament ws inserted";
		}
		else
		{
			return "position was invalid";
		}
	}
